...
source UATOMSagntintgServerList.sh
...
# Identify the server type based on the server name
  ...
  nohup /opt/IBM/OMS95/bin/$script_name $server_name \"$jvm_heapsize\" > "/var/IBM/WMS95/logs/TD_$server_name.log" 2>&1 &
...
start_health_monitor() {
  ...
  nohup /opt/IBM/OMS95/bin/startHealthMonitor.sh > "/var/IBM/WMS95/logs/TD_$server_name.log" 2>&1 &
