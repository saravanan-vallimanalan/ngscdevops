...
declare -A agentserver=(
    ...
    #["AEL_FullInvSnapshot_AS"]="-Xms512m -Xmx1024m -XX:PermSize1024m -XX:MaxPermSize1024m"
    ["AEL_WMS_Critical_AG1"]="-Xms512m -Xmx1024m"
    ["AEL_PickRTV_AS"]="-Xms512m -Xmx1024m"
    ["AEL_PinCodeFromWCS"]="-Xms512m -Xmx2048m"
    ["AEL_UpdateWavePlanningRule"]="-Xms512m -Xmx2048m"
...
declare -A integrationserver=(
    ...
    #["AEL_WMS_Critical_IS3"]="-Xms1280m -Xmx2560m -XX:PermSize128m -XX:MaxPermSize256m"
    ...
    ["AEL_UpdateShipmentLineEAN"]="-Xms512m -Xmx1024m"
    ["AEL_EventReport_IS"]="-Xms512m -Xmx2048m"
